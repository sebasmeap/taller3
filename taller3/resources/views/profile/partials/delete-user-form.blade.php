<section class="space-y-6 text-gray-200">
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6 bg-[#07122b] text-gray-200 rounded-xl">
            @csrf
            @method('delete')
            ...
            <div class="mt-6">
                ...
                <x-text-input
                    ...
                    name="password"
                    type="password"
                    class="mt-1 block w-3/4 bg-[#0b1736] border-red-800 text-white focus:border-red-500 focus:ring-red-500"
